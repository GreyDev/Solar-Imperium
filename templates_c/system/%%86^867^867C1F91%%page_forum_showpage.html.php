<?php /* Smarty version 2.6.19, created on 2009-05-24 23:46:45
         compiled from page_forum_showpage.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'page_forum_showpage.html', 2, false),)), $this); ?>
<?php ob_start(); ?>
                        ...
                        <tr>
                           ...
                           cellpadding="10" border="0">
                                    <tr>
                                        ...
                                        <td background="images/system/div_bg.jpg"><b><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Last Seen<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></b></td>
...
"><?php echo $this->_tpl_vars['items'][$this->_sections['item']['index']]['date']; ?>
                                        ...
                                        <td nowrap bgcolor="<?php echo $this->_tpl_vars['items'][$this->_sections['item']['index']]['bgcolor']; ?>
"><?php echo $this->_tpl_vars['items'][$this->_sections['item']['index']]['lastseen']; ?>
</td>
                                        <td nowrap bgcolor="<?php echo $this->_tpl_vars['items'][$this->_sections['item']['index']]['bgcolor']; ?>
