<?php /* Smarty version 2.6.19, created on 2009-09-12 01:54:05
         compiled from page_preferences.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'page_preferences.html', 2, false),array('modifier', 'date_format', 'page_preferences.html', 112, false),)), $this); ?>
<?php ob_start(); ?>
...
<div align="center" style="background-image:url(images/system/div_bg.jpg);background-color:#663333;padding:10px;border:1px solid red">
...
<td bgcolor="#ca3333" style="padding:5px" nowrap>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr><td><img src="images/common/star.gif" border="0">&nbsp;</td><td><b style="color:yellow">Player Profile</b></td></tr>
    </table>

</td>
<td bgcolor="darkred" style="padding:5px" nowrap><b><a class="link" href="gamesbrowser.php">Browse Available Games</a></b></td>
<td width="100%">&nbsp;</td>
</tr>
</table>

<div style="background-image:url(images/common/alpha1.png);border:1px solid #663333; padding:5px;color:#eaeaea;width:720px" align="left">
...
<?php if (isset ( $this->_tpl_vars['is_admin'] )): ?>
<input type="button" onClick="window.location='admin.php'" class="input_button" value="<?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Admin<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>">
<?php endif; ?>

<input type="button" onClick="window.location='welcome.php?LOGOFF'" class="input_button" value="<?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Logoff<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>">
</td>
</tr>
</table>
...
<table background="images/system/upgrade_bg.png" style="border:1px solid red" width="240" cellspacing="0" cellpadding="5">
<tr><td><img src="images/system/upgrade.png" border="0" alt="Upgrade"></td>
    <td><a class="text_big" style="color:red;text-decoration:none" href="premiumaccount.php"><b><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>PREMIUM ACCESS<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></b></a></td>
</tr>
<tr>
<td colspan="2">
<div align="right">
<a class="text_small" style="color:darkred" href="premiumaccount.php"><b><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>More details<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></b></a>
</div>
