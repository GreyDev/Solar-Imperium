<?php /* Smarty version 2.6.19, created on 2009-05-03 21:51:47
         compiled from page_forum_search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'page_forum_search.tpl', 2, false),)), $this); ?>
<?php ob_start(); ?>
...
" href="<?php echo $this->_tpl_vars['items'][$this->_sections['item']['index']]['url']; ?>
...
" nowrap><?php echo $this->_tpl_vars['items'][$this->_sections['item']['index']]['forum']; ?>
</td>
						<td nowrap bgcolor="<?php echo $this->_tpl_vars['items'][$this->_sections['item']['index']]['bgcolor']; ?>
"><?php echo $this->_tpl_vars['items'][$this->_sections['item']['index']]['date']; ?>
					...
					<?php endfor; else: ?>
					<tr>
						<td bgcolor="#dadaea" colspan="6" style="color:#333333" background="images/common/alpha2.png" class="text_normal"><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>No result found!<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
					</tr>
					<?php endif; ?>
				</table>
