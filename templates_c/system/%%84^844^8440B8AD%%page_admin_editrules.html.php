<?php /* Smarty version 2.6.19, created on 2009-05-25 00:58:03
         compiled from page_admin_editrules.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'page_admin_editrules.html', 2, false),)), $this); ?>
<?php ob_start(); ?>
<?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Admin :: Edit game rules<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
<form method="post" action="?UPDATERULES=<?php echo $this->_tpl_vars['game_id']; ?>
">

<b style="color:white" class="text_big">Edit game rules</b><br/>
<table class="text_normal">
<tr><td>
<textarea wrap="off" style="width:860px;height:660px;font-size:16px" class="input_text" name="filedata">
<?php echo $this->_tpl_vars['file_content']; ?>

</textarea>
</td>
</tr>
<tr><td><input class="input_button" type="submit" value="Save">&nbsp;<input class="input_button" type="button" value="Cancel" onclick="window.location='admin.php';"></td></tr>
</table>
</form>
