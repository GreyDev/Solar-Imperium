<?php /* Smarty version 2.6.19, created on 2009-09-13 00:36:06
         compiled from last_invasions.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'last_invasions.html', 4, false),)), $this); ?>
...
<form method="post" name="form1">
    <table width="780" bgcolor="darkred" cellspacing="1" cellpadding="0" border="0">
        <tr><td>
                ...
                <table cellpadding="6" bgcolor="#333333" width="100%" background="../images/game/background1.jpg">
                    <tr>
...
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['invasions']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                    <tr style="background-color:<?php echo $this->_tpl_vars['invasions'][$this->_sections['i']['index']]['bgcolor']; ?>
">
                        <td><?php echo $this->_tpl_vars['invasions'][$this->_sections['i']['index']]['date']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['invasions'][$this->_sections['i']['index']]['type']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['invasions'][$this->_sections['i']['index']]['outcome']; ?>
</td>
                        <td><b><a href="#" class="link" onClick="open_page('last_invasions.php?invasion=<?php echo $this->_tpl_vars['invasions'][$this->_sections['i']['index']]['id']; ?>
')"><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Details<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a></b></td>
                    </tr>

		<?php endfor; else: ?>
                    <tr><td colspan="4"><b><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>*** No invasions yet.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></b></td></tr>
		<?php endif; ?>
                </table>
