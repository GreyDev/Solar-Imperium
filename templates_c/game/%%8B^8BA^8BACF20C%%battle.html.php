...
<table width="780"  bgcolor="darkred" cellspacing="1" cellpadding="0" border="0">
    <tr>
        <td>
            ...
            <form action="#" method="post" onsubmit="ajax_submit_form('battle_nuclearwarfare.php',this);return false;" name="form_nuke">
...
"><?php echo $this->_tpl_vars['empires'][$this->_sections['e']['index']]['name']; ?>
		...
		<?php endfor; endif; ?>
            ...
            <form action="#" onsubmit="ajax_submit_form('battle_invasion.php',this); return false;" method="post" name="form1">
                <table width="100%" align="center" cellspacing="0"
                       cellpadding="5" border="0" style="font-size:11pt" bgcolor="#333333"
                ...
                <tr><td>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                                ...
                                <td colspan="2" align="right"><b><a href="#" class="link" onClick="if (confirm('<?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Retreating will affect troops morale if your convoy is far from your empire, do it?<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>')) open_page('battle.php?retreat=<?php echo $this->_tpl_vars['convoys'][$this->_sections['c']['index']]['id']; ?>
')"><?php echo $this->_tpl_vars['convoys'][$this->_sections['c']['index']]['retreat']; ?>
</a></b></td>
                            </tr>
                            <tr>
...
<?php endfor; endif; ?>
                            ...
                            <b style="color:yellow">
                                <a href="javascript:show_help('battle_invasion')" class="link" onmouseover="ajax_showTooltip('galaxypedia_short.php?search=battle_invasion',this);return false" onmouseout="ajax_hideTooltip()">
...
;return false;">MAX</a>: <?php echo ((is_array($_tmp=$this->_tpl_vars['invasion_heavycruisers'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : smarty_modifier_number_format($_tmp)); ?>
            ...
            <form  action="#" onsubmit="ajax_submit_form('battle_guerilla.php',this); return false;"  method="post" name="form2">
                <table width="100%" align="center" cellspacing="0"
                       cellpadding="5" border="0" style="font-size:11pt" bgcolor="#333333"
                       background="../images/game/background1.jpg">
		...
		<?php endfor; endif; ?>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="guerilla_soldiers"  style="width:100px" class="input_text"  value="0">
                            <b>
                                <a class="link" href="#"  onClick="form2.guerilla_soldiers.value=Math.floor(<?php echo $this->_tpl_vars['guerilla_soldiers']; ?>
/4);return false;">25%</a>
                                <a class="link" href="#"  onClick="form2.guerilla_soldiers.value=Math.floor(<?php echo $this->_tpl_vars['guerilla_soldiers']; ?>
/2);return false;">50%</a>
                                <a class="link" href="#"  onClick="form2.guerilla_soldiers.value=Math.floor((<?php echo $this->_tpl_vars['guerilla_soldiers']; ?>
/4)*3);return false;">75%</a>
                                <a class="link" href="#" onClick="form2.guerilla_soldiers.value=<?php echo $this->_tpl_vars['guerilla_soldiers']; ?>
;return false;">MAX</a>: <?php echo ((is_array($_tmp=$this->_tpl_vars['guerilla_soldiers'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : smarty_modifier_number_format($_tmp)); ?>
            ...
            <form action="#" onsubmit="ajax_submit_form('battle_pirate.php',this); return false;" method="post" name="form3">
                <table width="100%" align="center" cellspacing="0"
                       cellpadding="5" border="0" style="font-size:11pt" bgcolor="#333333"
                       background="../images/game/background1.jpg">
