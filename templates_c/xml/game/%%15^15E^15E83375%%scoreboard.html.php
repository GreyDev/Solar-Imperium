...
">
				<table cellspacing="0" cellpadding="2" border="0">
					<tr>
						<td><a
							href="javascript:show_coalition(<?php echo $this->_tpl_vars['coalition_toplist'][$this->_sections['ct']['index']]['id']; ?>
)"
							style="text-decoration:none;color:<?php echo $this->_tpl_vars['coalition_toplist'][$this->_sections['ct']['index']]['color']; ?>
"><img
							src="<?php echo $this->_tpl_vars['coalition_toplist'][$this->_sections['ct']['index']]['img_logo']; ?>
" width="32" height="32"
							border="1" bordercolor="yellow" style="color:yellow"></td>
...
" width="32" height="32" border="1"
							bordercolor="yellow" style="border-color:yellow"></td>
